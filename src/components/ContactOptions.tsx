        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            <div className="bg-white p-8 rounded-lg shadow-md transition-transform duration-300 hover:translate-y-[-5px] animate-fade-up">
              <div className="w-16 h-16 mx-auto bg-jet-800 text-white rounded-full flex items-center justify-center mb-6">
                <Phone size={24} />
              </div>
              ...
              <a href="tel:+12345678900" className="elegant-button inline-block">
                +1 234 567 8900
              </a>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md transition-transform duration-300 hover:translate-y-[-5px] animate-fade-up" style={{ animationDelay: '100ms' }}>
              <div className="w-16 h-16 mx-auto bg-gold-600 text-white rounded-full flex items-center justify-center mb-6">
              ...
              <a 
                ...
                className="elegant-button-gold inline-block"
              >
                WhatsApp Connect
              </a>
            </div>
